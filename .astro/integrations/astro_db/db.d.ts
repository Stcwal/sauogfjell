...
declare module 'astro:db' {
	...
	export const Songs: import("@astrojs/db/runtime").Table<
		"Songs",
		{"songID":{"type":"number","schema":{"unique":false,"deprecated":false,"name":"songID","collection":"Songs","primaryKey":true}},"artistName":{"type":"text","schema":{"unique":false,"deprecated":false,"name":"artistName","collection":"Songs","primaryKey":false,"optional":false}},"songName":{"type":"text","schema":{"unique":false,"deprecated":false,"name":"songName","collection":"Songs","primaryKey":false,"optional":false}},"elo":{"type":"number","schema":{"unique":false,"deprecated":false,"name":"elo","collection":"Songs","primaryKey":false,"optional":false}},"numMatches":{"type":"number","schema":{"unique":false,"deprecated":false,"name":"numMatches","collection":"Songs","primaryKey":false,"optional":false}},"qualified":{"type":"boolean","schema":{"optional":false,"unique":false,"deprecated":false,"name":"qualified","collection":"Songs"}},"albumCoverLink":{"type":"text","schema":{"unique":false,"deprecated":false,"name":"albumCoverLink","collection":"Songs","primaryKey":false,"optional":false}}}
	>;
