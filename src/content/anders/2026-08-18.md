...
Jeg tviler på at det er noe annerledes i England, men jeg hadde jo håpet at New Zealand ikke skulle synke så dypt at de må kalle Fusilli for SPIRALS. Det er et elendig navn. Først og fremst er det ikke en spiral. En spiral er definert som $x=r(\theta)\cos(\theta),\ y=r(\theta)\sin(\theta)$ og ser ut som dette:

![Spiral](./images/2026-08-18_Spiral.png)

Legg merke til at det er en **to-dimensjonal** form. Jeg ser hvertfall ikke noe tredje koordinat. Så hvilken del av en en fusilli som er i 2D skjønner jeg ikke. Åja, tverrsnittet, sier du. Det er jo ikke en spiral det heller!!!
